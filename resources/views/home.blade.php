    ...
    <div class="hero-wrap js-fullheight">
        ...
        <div class="container-fluid px-0">
            <div id="barcar"
                ...
                <img class="one-third js-fullheight align-self-end order-md-first img-fluid" id="logo-img"
                    src="images/Logo (3).svg" alt="">
                <div class="one-forth d-flex align-items-center ftco-animate js-fullheight">
                    <div class="text mt-5" style="">
                        <h1 class="mb-1">Ideas</h1>
                        <h1 style="color: rgb(110, 226, 100);">/Creative Lab</h1>
                        <p>Espaço dedicado ao desenvolvimento de software com foco na criatividade e na experiência do
                            usuário
                        </p>
            ...
            <div class="row">
                @foreach ($projects as $project)
                    <div style="word-break: break-word !important;"
                        class="col-lg-4 col-md-6 d-flex align-self-stretch ftco-animate">
                        <div class="media block-6 services d-flex flex-column">
                            <div class="media-body pl-4 d-flex flex-column">
                                ...
                                <p>{{ $project->resume }}</p>
                                <div class="mt-auto">
                                    <a href="{{ route('showproject', $project->id) }}" class="btn btn-primary px-4 py-3">Ver
                                        mais</a>
                                </div>
                            </div>
                        </div>
